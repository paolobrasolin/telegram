    ...
    module Bot
      module Types
        ...
        Message = Struct.new(:message_id, :from, :date, :chat, :forward_from, :forward_from_chat, :forward_from_message_id, :forward_signature, :forward_date, :reply_to_message, :edit_date, :author_signature, :text, :entities, :caption_entities, :audio, :document, :game, :photo, :sticker, :video, :voice, :video_note, :caption, :contact, :location, :venue, :new_chat_members, :left_chat_member, :new_chat_title, :new_chat_photo, :delete_chat_photo, :group_chat_created, :supergroup_chat_created, :channel_chat_created, :migrate_to_chat_id, :migrate_from_chat_id, :pinned_message, :invoice, :successful_payment) do
          def initialize(message_id:, from: nil, date:, chat:, forward_from: nil, forward_from_chat: nil, forward_from_message_id: nil, forward_signature: nil, forward_date: nil, reply_to_message: nil, edit_date: nil, author_signature: nil, text: nil, entities: nil, caption_entities: nil, audio: nil, document: nil, game: nil, photo: nil, sticker: nil, video: nil, voice: nil, video_note: nil, caption: nil, contact: nil, location: nil, venue: nil, new_chat_members: nil, left_chat_member: nil, new_chat_title: nil, new_chat_photo: nil, delete_chat_photo: nil, group_chat_created: nil, supergroup_chat_created: nil, channel_chat_created: nil, migrate_to_chat_id: nil, migrate_from_chat_id: nil, pinned_message: nil, invoice: nil, successful_payment: nil)
