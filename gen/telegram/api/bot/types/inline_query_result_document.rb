    ...
    module Bot
      module Types
        ...
        InlineQueryResultDocument = Struct.new(:type, :id, :title, :caption, :document_url, :mime_type, :description, :reply_markup, :input_message_content, :thumb_url, :thumb_width, :thumb_height) do
          def initialize(type:, id:, title:, caption: nil, document_url:, mime_type:, description: nil, reply_markup: nil, input_message_content: nil, thumb_url: nil, thumb_width: nil, thumb_height: nil)
